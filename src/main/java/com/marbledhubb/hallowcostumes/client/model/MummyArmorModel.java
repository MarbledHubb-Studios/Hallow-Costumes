...
public class MummyArmorModel extends GeoModel<MummyArmorItem> {
    ...
    public ResourceLocation getModelResource(MummyArmorItem animatable) {
        return ResourceLocation.fromNamespaceAndPath(HallowCostumes.MODID, "geo/mummy_armor.geo.json");
    }

    @Override
    public ResourceLocation getTextureResource(MummyArmorItem animatable) {
        return ResourceLocation.fromNamespaceAndPath(HallowCostumes.MODID, "textures/armor/mummy_armor.png");
    }

    @Override
    public ResourceLocation getAnimationResource(MummyArmorItem animatable) {
        return ResourceLocation.fromNamespaceAndPath(HallowCostumes.MODID, "animations/mummy_armor.animation.json");
    }
}
