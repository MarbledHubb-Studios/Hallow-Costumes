...
public class FreddyArmorModel extends GeoModel<FreddyArmorItem> {
    ...
    public ResourceLocation getModelResource(FreddyArmorItem animatable) {
        return ResourceLocation.fromNamespaceAndPath(HallowCostumes.MODID, "geo/freddy_helmet.geo.json");
    }

    @Override
    public ResourceLocation getTextureResource(FreddyArmorItem animatable) {
        return ResourceLocation.fromNamespaceAndPath(HallowCostumes.MODID, "textures/armor/freddy_helmet.png");
    }

    @Override
    public ResourceLocation getAnimationResource(FreddyArmorItem animatable) {
        return ResourceLocation.fromNamespaceAndPath(HallowCostumes.MODID, "animations/freddy_helmet.animation.json");
    }
}
